...
const BTN = 38;
// Logo natif : 200×83 — on le fixe à BTN px de hauteur, largeur proportionnelle
const LOGO_H = BTN;
const LOGO_W = Math.round((200 / 83) * LOGO_H); // ≈ 92
...
function CollectionBtn({ count }: { count: number }) {
  const [hovered, setHovered] = useState(false);
  return (
    <motion.button
      title="Collection"
