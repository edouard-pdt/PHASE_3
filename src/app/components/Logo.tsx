...
export function Logo() {
  return (
    <div
      // 🛠️ Ajout de shrink-0 et select-none pour stabiliser le comportement dans le Header flex
      className="bg-[#131313] gap-y-[13px] grid grid-cols-[repeat(5,fit-content(100%))] grid-rows-[repeat(2,fit-content(100%))] px-[22px] py-[12px] rounded-full shrink-0 select-none items-center justify-items-center"
      // 🛠️ Fixation stricte de la largeur pour empêcher l'écrasement horizontal des colonnes fit-content
      style={{ 
    ...
    >
      ...
      <div className="bg-[#eba7be] col-3 relative row-1 shrink-0 size-[19px] rounded-[3px]" />
